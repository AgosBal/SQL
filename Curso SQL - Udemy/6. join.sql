...
drop table if exists libros, socios, prestamos;
 ...
 #Trae todos los datos con coincidencia
 ...
 #Muestra todos los resultados, incluídos los que no coinciden o tienen datos vacíos
 select nombre, titulo, fechaprestamo
 from prestamos as p
...
DROP FOREIGN KEY productos_ibfk_1; -- Replace with the actual constraint name
